...
export default function RootLayout({ children }: { children: React.ReactNode }) {
	const jsonLd = {
		...
		url: 'https://mi-shraban.github.io',
		image: 'https://mi-shraban.github.io/photos/profile.png',
		...
		itemListElement: [
			{
				...
				position: 1,
				name: 'Home',
				item: 'https://mi-shraban.github.io'
			},
			{
				'@type': 'ListItem',
				position: 2,
				name: 'Codeforces Solutions',
				item: 'https://mi-shraban.github.io/cfsolves'
			}
		]
	}
	...
	return (
		...
		<head>
			...
			<link rel="canonical" href="https://mi-shraban.github.io"/>
			<script
