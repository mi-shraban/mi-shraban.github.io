...
//                 .sort((a, b) => b[1] - a[1])
//                 .slice(0, 2);
//             const topLanguageNames = topLanguages.map(item => item[0]);
//
//             filtered.push({
//                 sub_id: sub.id,
//                 name: problemName,
...
//                 </div>
//                 <div class="stat-item">
//                     <div class="stat-number">${sortedLanguageCount[0]}, ${sortedLanguageCount[1]}</div>
...
//             const contestIdOnly = entry.id.slice(0, -1);
//             const contestIdLevel = entry.id.slice(-1);
//
//             html += `
//                 <div class="submission-item">
//                     <div class="problem-title">
//                         Problem:
//                         <a href="https://codeforces.com/contest/${contestIdOnly}/problem/${contestIdLevel}" target="_blank" class="problem-title2">
//                             [${entry.name}]
//                         </a>
//                     </div>
//                     <div class="submission-details">Language: ${entry.language}</div>
//                     <div class="tag">
//                         <a href="https://codeforces.com/contest/${contestIdOnly}/submission/${entry.sub_id}"
